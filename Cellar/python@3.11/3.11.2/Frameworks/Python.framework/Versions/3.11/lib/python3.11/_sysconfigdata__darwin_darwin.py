...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr/local/opt/python@3.11' "
                ...
                "'PKG_CONFIG_PATH=/usr/local/opt/openssl@1.1/lib/pkgconfig:/usr/local/opt/readline/lib/pkgconfig:/usr/local/opt/sqlite/lib/pkgconfig:/usr/local/opt/xz/lib/pkgconfig:/usr/local/opt/libffi/lib/pkgconfig' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2/lcov-report',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/usr/local/Cellar/libffi/3.4.4/include',
 'LIBM': '',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/usr/local/opt/openssl@1.1/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/usr/local/opt/openssl@1.1/lib   -lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/usr/local/Cellar/xz/5.4.1/include',
 'MODULE__LZMA_LDFLAGS': '-L/usr/local/Cellar/xz/5.4.1/lib -llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/usr/local/Cellar/sqlite/3.40.1/include '
                           '-I./Modules/_sqlite',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/usr/local/Cellar/sqlite/3.40.1/lib -lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/usr/local/opt/openssl@1.1/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/usr/local/opt/openssl@1.1/lib  -lssl -lcrypto',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2 '
               './python.exe -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2 '
 ...
 'abs_builddir': '/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2',
 'abs_srcdir': '/private/tmp/pythonA3.11-20230214-62519-z7stio/Python-3.11.2',
 'datarootdir': '/usr/local/opt/python@3.11/share',
