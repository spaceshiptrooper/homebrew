...
/* Location of the MIME types config file, relative to the Apache root
   directory */
#define AP_TYPES_CONFIG_FILE "/usr/local/etc/httpd/mime.types"
...
#define HTTPD_ROOT "/usr/local/opt/httpd"
...
#define SERVER_CONFIG_FILE "/usr/local/etc/httpd/httpd.conf"
...
#define SUEXEC_BIN "/usr/local/opt/httpd/bin/suexec"
