...
/* Install bindir */
#define BIN_PREFIX "/usr/local/Cellar/unixodbc/2.3.11/bin"
...
/* Lib directory */
#define DEFLIB_PATH "/usr/local/Cellar/unixodbc/2.3.11/lib"
...
/* Install exec_prefix */
#define EXEC_PREFIX "/usr/local/Cellar/unixodbc/2.3.11"
...
/* Install includedir */
#define INCLUDE_PREFIX "/usr/local/Cellar/unixodbc/2.3.11/include"

/* Lib directory */
#define LIB_PREFIX "/usr/local/Cellar/unixodbc/2.3.11/lib"
...
/* Install prefix */
#define PREFIX "/usr/local/Cellar/unixodbc/2.3.11"
...
/* Lib path */
#define SYSTEM_LIB_PATH "/usr/local/Cellar/unixodbc/2.3.11/lib"
