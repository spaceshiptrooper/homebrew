...
if ('/usr/local/Cellar/php/8.2.2/share/php/pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/usr/local/Cellar/php/8.2.2/share/php/pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
