...
Pygments.egg-info/requires.txt
...
doc/_themes/pygments14/relations.html
...
scripts/check_whitespace_token.py
...
tests/contrast/test_contrasts.py
...
tests/examplefiles/ada/test_ada2022.adb.output
tests/examplefiles/ada/test_ada_aspects.ads
tests/examplefiles/ada/test_ada_aspects.ads.output
...
tests/examplefiles/arturo/arturo_test.art
tests/examplefiles/arturo/arturo_test.art.output
...
tests/examplefiles/capnp/pets.capnp
tests/examplefiles/capnp/pets.capnp.output
...
tests/examplefiles/comal80/test.comal
tests/examplefiles/comal80/test.comal.output
...
tests/examplefiles/control/control
...
tests/examplefiles/coq/coq_test
tests/examplefiles/coq/coq_test.output
...
tests/examplefiles/fift/new-wallet-v3.fif
tests/examplefiles/fift/new-wallet-v3.fif.output
...
tests/examplefiles/func/test.fc
tests/examplefiles/func/test.fc.output
...
tests/examplefiles/gap-repl/euclidean.tst
tests/examplefiles/gap-repl/euclidean.tst.output
tests/examplefiles/gap-repl/magma.tst
tests/examplefiles/gap-repl/magma.tst.output
...
tests/examplefiles/go/generics.go
tests/examplefiles/go/generics.go.output
...
tests/examplefiles/isabelle/example_ascii.thy
tests/examplefiles/isabelle/example_ascii.thy.output
tests/examplefiles/isabelle/example_unicode.thy
tests/examplefiles/isabelle/example_unicode.thy.output
...
tests/examplefiles/jmespath/example.jp
tests/examplefiles/jmespath/example.jp.output
...
tests/examplefiles/json/json-with-spaces.json
tests/examplefiles/json/json-with-spaces.json.output
tests/examplefiles/json/pypi-dump.json
tests/examplefiles/json/pypi-dump.json.output
tests/examplefiles/jsonld/example.jsonld
tests/examplefiles/jsonld/example.jsonld.output
tests/examplefiles/jsonnet/example.jsonnet
tests/examplefiles/jsonnet/example.jsonnet.output
...
tests/examplefiles/mcschema/actor_animation.mcschema
tests/examplefiles/mcschema/actor_animation.mcschema.output
tests/examplefiles/mcschema/attribute.mcschema
tests/examplefiles/mcschema/attribute.mcschema.output
tests/examplefiles/mcschema/geometry.mcschema
tests/examplefiles/mcschema/geometry.mcschema.output
tests/examplefiles/mcschema/manifest.mcschema
tests/examplefiles/mcschema/manifest.mcschema.output
...
tests/examplefiles/mips/function_with_stack.mips
tests/examplefiles/mips/function_with_stack.mips.output
...
tests/examplefiles/nasm/nasm_simd.asm
tests/examplefiles/nasm/nasm_simd.asm.output
...
tests/examplefiles/objdump-nasm/no-show-raw-isns.dump
tests/examplefiles/objdump-nasm/no-show-raw-isns.dump.output
...
tests/examplefiles/phix/example.exw
tests/examplefiles/phix/example.exw.output
...
tests/examplefiles/portugol/example.alg
tests/examplefiles/portugol/example.alg.output
...
tests/examplefiles/prolog/strings.prolog
tests/examplefiles/prolog/strings.prolog.output
...
tests/examplefiles/python/switch_case.txt
...
tests/examplefiles/rita/example.rita
tests/examplefiles/rita/example.rita.output
...
tests/examplefiles/scilab/bench_chol.tst
tests/examplefiles/scilab/bench_chol.tst.output
...
tests/examplefiles/sed/all_sorts_of_syntax.sed
tests/examplefiles/sed/all_sorts_of_syntax.sed.output
tests/examplefiles/sed/count_words.sed
tests/examplefiles/sed/count_words.sed.output
tests/examplefiles/sed/increment_number.sed
tests/examplefiles/sed/increment_number.sed.output
tests/examplefiles/sed/reverse.sed
tests/examplefiles/sed/reverse.sed.output
...
tests/examplefiles/sophia/test.aes
tests/examplefiles/sophia/test.aes.output
...
tests/examplefiles/spice/dijkstra.spice
tests/examplefiles/spice/dijkstra.spice.output
...
tests/examplefiles/sql+jinja/example.sql
tests/examplefiles/sql+jinja/example.sql.output
...
tests/examplefiles/srcinfo/c-intercal.SRCINFO
tests/examplefiles/srcinfo/c-intercal.SRCINFO.output
tests/examplefiles/srcinfo/compiler-rt.SRCINFO
tests/examplefiles/srcinfo/compiler-rt.SRCINFO.output
tests/examplefiles/srcinfo/hunspell.SRCINFO
tests/examplefiles/srcinfo/hunspell.SRCINFO.output
tests/examplefiles/srcinfo/thunderbird.SRCINFO
tests/examplefiles/srcinfo/thunderbird.SRCINFO.output
...
tests/examplefiles/tlb/block.tlb
tests/examplefiles/tlb/block.tlb.output
...
tests/examplefiles/wowtoc/comments.toc
tests/examplefiles/wowtoc/comments.toc.output
tests/examplefiles/wowtoc/files.toc
tests/examplefiles/wowtoc/files.toc.output
tests/examplefiles/wowtoc/official_tags.toc
tests/examplefiles/wowtoc/official_tags.toc.output
tests/examplefiles/wowtoc/other_tags.toc
tests/examplefiles/wowtoc/other_tags.toc.output
tests/examplefiles/wren/example.wren
tests/examplefiles/wren/example.wren.output
...
tests/snippets/c/test_function_comments.txt
...
tests/snippets/c/test_string_resembling_decl_end.txt
...
tests/snippets/cpp/test_unicode_identifiers.txt
...
tests/snippets/fortran/test_string_cataback.txt
...
tests/snippets/java/test_multiline_string.txt
tests/snippets/java/test_multiline_string_only.txt
...
tests/snippets/matlabsession/test_wrong_continuation.txt
...
tests/snippets/mips/deprecated_substrings.txt
tests/snippets/mips/keyword_substrings.txt
tests/snippets/mips/variable_substrings.txt
tests/snippets/nasm/checkid.txt
...
tests/snippets/php/test_backslashes_in_strings.txt
...
tests/snippets/pwsh-session/test_continuation.txt
tests/snippets/python/test_bytes_escape_codes.txt
...
tests/snippets/python/test_string_escape_codes.txt
...
tests/snippets/tcl/test_vars.txt
...
tests/snippets/wren/lonely-paren.txt
tests/snippets/xml/multiline-comment-catastrophic-backtracking.txt
tests/snippets/yaml/test_yaml.txt
tests/snippets/yaml/test_yaml_colon_in_key.txt
tests/snippets/yaml/test_yaml_colon_in_key_double.txt
tests/snippets/yaml/test_yaml_colon_in_key_start.txt
...
tests/support/structural_diff.py
tests/support/tags