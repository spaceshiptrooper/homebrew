...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=/usr/local/Cellar/libpq/15.2' '--with-gssapi' '--with-openssl' '--libdir=/usr/local/opt/libpq/lib' '--includedir=/usr/local/opt/libpq/include' 'CC=clang' 'CXX=clang++' 'PKG_CONFIG_PATH=/usr/local/opt/openssl@1.1/lib/pkgconfig:/usr/local/opt/krb5/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/usr/local/Homebrew/Library/Homebrew/os/mac/pkgconfig/10.14'"
...
#define PG_VERSION_STR "PostgreSQL 15.2 on x86_64-apple-darwin18.7.0, compiled by Apple LLVM version 10.0.1 (clang-1001.0.46.4), 64-bit"
